...
INDEX_URL = "https://seesaawiki.jp/mokugyo/d/%b2%d0%ce%ee%b7%cf%bc%f6%ca%b8"
...
def main():
    ...
    print(f"Collected {len(spells)} fire spells from index.")
    
    output_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), "../../scratch")
    os.makedirs(output_dir, exist_ok=True)
    json_path = os.path.join(output_dir, "fire_spells_data.json")
    ...
    print(f"\nAll fire spells fetched! Saved to {json_path}")
