$lines = [System.IO.File]::ReadAllLines("scratch_501_600_table.txt", [System.Text.Encoding]::UTF8)
$clean = @()
...
[System.IO.File]::WriteAllLines("scratch_501_600_clean_summary.txt", $clean, [System.Text.Encoding]::UTF8)
