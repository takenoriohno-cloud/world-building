$lines = [System.IO.File]::ReadAllLines("scratch_601_700_table.txt", [System.Text.Encoding]::UTF8)
$clean = @()
...
[System.IO.File]::WriteAllLines("scratch_601_700_clean_summary.txt", $clean, [System.Text.Encoding]::UTF8)
