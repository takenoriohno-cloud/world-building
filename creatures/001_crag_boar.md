...
| **主要生息域** | 関東結界都市 外壁近郊アウトランド第1〜第2区（旧多摩丘陵・丹沢外縁・奥多摩廃墟群） |
...
### 2.2 変異・覚醒の経緯
2000年のミレニアム・アウェイクニング以降、関東山地から多摩・丹沢地域の旧土壌に堆積した鉱物資源と湧出マナに晒されたニホンイノシシが急速に変異。わずか3〜4世代の短期間で骨格の大型化と外皮の石化変異が定着した。
...
### 4.1 魔力現象と発現メカニズム
- **生体ケイ素硬化反応**: 
  - 本種は能動的な魔術詠唱や魔術障壁の展開を行わない（非知性魔獣）。
  - しかし、体内のマナ受容細胞が筋肉の収縮に連動して微小な反発力場（パッシブ・キネティック・ダンパー）を形成。これにより、突進衝突時の自己脳震盪を防ぎ、外部衝撃を全身の針毛へ分散させる。
...
【有効射撃ポイント】
 ...
 12.7×99mm 対物ライフル ─────────────> [頭部正面でも骨板ごと粉砕・即死]
```

- **推奨火器**:
  - **小口径小銃（5.56mm NATO / 89式小銃等）**: 正面からの射撃は前頭骨シールドで跳弾する危険性が高い。側面からの眼窩・頚部狙撃に限定。
  - **推奨標準火器**: **12ゲージ散弾銃（非鉛硬質スラッグ弾）**、または **7.62×51mm NATO弾（豊和20式・64式7.62mm小銃等）**。
  - **重火器**: 車載 **12.7mm重機関銃（M2）** または 40mm自動擲弾銃。正面からの一撃で骨板ごと粉砕・無力化可能。
- **専門魔法部隊の要否**: **不要**。現代通常兵器の物理運動エネルギーで100%制圧可能。
...
- **下処理・調理プロトコル**: 
  ...
  - **処理基準**: 認可魔獣調理施設において、内臓（特に肝臓・胆嚢・脾臓）を肉に接触させず摘出・焼却。中心温度 **85℃以上で15分間以上の加熱調理**（煮込み、または長時間のロースト）が義務付けられている。
- **風味・食感**: 
  - 「巌猪鍋（ガンチョ鍋）」として結界都市内の高級料亭やジビエ専門店で流通。噛むほどに深い野性味と脂の甘みが広がる。

### 6.2 素材採取と工業・医療利用
- **採取可能素材**:
  1. **巌猪の剛毛（シリカ・ニードル）**: 高強度・軽量な防刃・防破片繊維として民間PMC用ベストの織込素材に利用（1kgあたり市場価格 約8万円）。
  2. **頭骨湾曲板（クラニアル・シールド）**: 破砕して耐熱セラミックス複合材の骨材に転用。
...
> *「新米のハンターがよくやるミスが、正面から5.56mmのフルオートを頭に叩き込むことだ。火花が散って跳弾し、逆上した300キロの岩塊が時速50キロで突っ込んでくる。  
> 奴を仕留めたけりゃ、横に跳んで脇腹に12番スラッグを叩き込むか、最初から自衛隊のブローニング（12.7mm）を持ってくるこった。  
> だがな、苦労してバラした後のバラ肉を味噌仕立てで煮込んだ鍋は……壁外の命がけの仕事をすべて忘れさせてくれる味だよ」*  
> —— **関東結界都市公認 害獣駆除PMC「多摩レンジャーズ」隊長・陣内 剛造**（2025年 駆除報告書より）
