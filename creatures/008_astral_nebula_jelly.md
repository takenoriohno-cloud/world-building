...
flowchart LR
    ...
    DEPTH["マリアナ海溝大断層 / 太平洋深海<br/>(水深1,000〜3,000m 一次野生生息地)"] -->|新月期・海洋深層湧昇流| COAST["東京湾口（浦賀水道） / 房総・相模湾沖<br/>(夜間沿岸ブルーム・海面空中浮遊群)"]
    
    subgraph OCEAN["海洋生態・航行影響"]
        COAST -->|星雲燐光・ソナー乱反射| SHIP["沿岸漁船・海上保安庁特務艇<br/>(アクティブソナー 2〜5kHz 航路誘導)"]
        COAST -->|刺胞胞子飛散| FOG["海面アストラル霧<br/>(乗組員に集団多幸感・酩酊リスク)"]
    end

    COAST -->|認可漁船・専用大型ゲルネット捕獲| HARBOR["豊洲新中央魔獣市場・水産特科棟<br/>(Class-B 専門解体・ミョウバン粗塩蔵処理)"]
    
    subgraph UTIL["高度産業・医療・食文化"]
        HARBOR --> LAB["三ツ菱マナテック 先端光学バイオ研<br/>・生体ホログラム素子"]
        HARBOR --> PHARMA["テイコク製薬 先端生薬開発部<br/>・精神安定医療パッチ"]
        HARBOR --> GOURMET["銀座・日本橋 超高級料亭<br/>・『星海月薄造り』(一皿数万円)"]
    end
```
