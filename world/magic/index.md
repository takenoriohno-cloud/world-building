...
**主管部署**: 魔導科学・理論研究部  
**準拠文献**: 『ガープス第4版 魔法大全（GURPS Magic）』、公式サプリメント各編（`magic_page_001`〜`300`）  
**準拠憲章**: `AGENTS.md` (ガープスマジック基準魔術出力・4大魔術体系分類)

---

## 1. 魔法基礎ルール・力学・代替体系 (Rules & Theories)

| ファイル | 内容概要 | リンク |
| :--- | :--- | :--- |
| **基本原則・力学** | マナレベル（無・疎・並・濃・超濃）、素質、詠唱時間、消費・維持、抵抗力学、TL修正、儀礼魔法、範囲呪文、杖・錫杖、長距離修正、白兵・射撃保持、新呪文開発 | [principles.md](file:///c:/Users/user/OneDrive/ドキュメント/Antigravity/world-building/world/magic/rules/principles.md) |
| **魔化力学・呪具経済** | 魔化の二大製造プロセス（手軽で危ない vs ゆっくり確実）、品物のパワー、魔力石（パワーストーン）価格方程式と歪み表、メガコーポ呪具流通グレード | [enchantment.md](file:///c:/Users/user/OneDrive/ドキュメント/Antigravity/world-building/world/magic/rules/enchantment.md) |
| **代替魔法体系** | 僧侶魔法と神聖性（極高〜なし）、儀式魔法（パス魔術 / Ritual Magic）、前提条件変更・名称変更、新人類プレーン・パクトとアビス呪術 | [alternate_systems.md](file:///c:/Users/user/OneDrive/ドキュメント/Antigravity/world-building/world/magic/rules/alternate_systems.md) |
| **現代錬金術・霊薬学** | 錬金術技能、霊薬4大形態（水薬/粉薬/煙薬/塗薬）、8大霊薬分類、霊晶、アルカヘスト、賢者の石、テイコク製薬生薬経済とバイオハザード | [alchemy.md](file:///c:/Users/user/OneDrive/ドキュメント/Antigravity/world-building/world/magic/rules/alchemy.md) |
| **術語・紋章・即席魔法** | 万能の天才/万能魔法、術語魔法（名詞動詞魔術・電脳言語化）、紋章魔法（フサルク/オガム）、要塞防壁ハイブリッド装甲 | [syntactic_and_symbol.md](file:///c:/Users/user/OneDrive/ドキュメント/Antigravity/world-building/world/magic/rules/syntactic_and_symbol.md) |
| **高度流派・砲兵・RPM** | 軍事砲兵系呪文（Artillery）、致死・禁忌系呪文（Death/Class-C）、簡単生活呪文（Cantrips）、儀式パス魔術（RPM） | [advanced_styles.md](file:///c:/Users/user/OneDrive/ドキュメント/Antigravity/world-building/world/magic/rules/advanced_styles.md) |
| **流派・特典・奥義呪文** | 魔法系特典（Magical Perks）、奥義呪文（Secret Spells / VH・スロット強化）、改造オプション（威力/消費/準備等）、メガコーポ特許術式 | [magical_styles_and_perks.md](file:///c:/Users/user/OneDrive/ドキュメント/Antigravity/world-building/world/magic/rules/magical_styles_and_perks.md) |
| **魔獣生体・スケール力学** | 能力値基準（ST/DX/IQ/HT）、副能力値（BL/HP/FP/BS/BM）、サイズ修正（SM:-3〜+7）、速度/距離修正表、現代銃火器弾道学グラウンディング | [creature_mechanics.md](file:///c:/Users/user/OneDrive/ドキュメント/Antigravity/world-building/world/magic/rules/creature_mechanics.md) |
| **生体異能・才能力学** | 生体武器・ブレス（Innate Attack）、貫通力修正（Armor Divisor）、活力供給源（ER）、専門才能（Talents）、宇宙パワー（Cosmic） | [innate_attacks_and_traits.md](file:///c:/Users/user/OneDrive/ドキュメント/Antigravity/world-building/world/magic/rules/innate_attacks_and_traits.md) |
| **技能・テクニック力学** | 技能難易度・CP表、現代魔導・軍事・解体技能、タクティカル・テクニック（急所狙い/障壁偏向/移動詠唱）、万能技能! | [skills_and_tactics.md](file:///c:/Users/user/OneDrive/ドキュメント/Antigravity/world-building/world/magic/rules/skills_and_tactics.md) |
| **社会・新人類・特徴力学** | 文明レベル（TL8〜9）、階級・地位（Status/Rank）、新人類形質（エルフ/ドワーフ/トロール）、身元偽装・情報屋、アビス狂気自制判定 | [social_and_traits.md](file:///c:/Users/user/OneDrive/ドキュメント/Antigravity/world-building/world/magic/rules/social_and_traits.md) |
| **上級魔導・注入・閾値力学** | 武器・弾薬へのマナ注入（Imbuements）、真の信仰、マナ増幅/除去、閾値魔法（Tally/Calamity）、四大源素精霊、真名・生贄・死の呪い、超能力対比 | [advanced_thaumatology.md](file:///c:/Users/user/OneDrive/ドキュメント/Antigravity/world-building/world/magic/rules/advanced_thaumatology.md) |
| **武器・防具・装備・経済力学** | 武器ステータス標準（Damage/Acc/Range/RoF/ST/Bulk/Rcl）、合法レベル（LC0〜4）、生活費・宿泊費・食費、武器品質、特殊素材（オリハルコン/銀製/ボドキン）、手榴弾・信管 | [weapons_and_equipment.md](file:///c:/Users/user/OneDrive/ドキュメント/Antigravity/world-building/world/magic/rules/weapons_and_equipment.md) |
| **環境・サバイバル・状態異常** | 自然治癒・意識不明覚醒、FP極限・飢餓渇き不眠、状態異常3大分類（集中妨害/無力化/致死）、酸DR侵食、極寒凍傷・高山病、落下激突、感電サージ・金属鎧無効、火災延焼消火 | [hazards_survival_and_recovery.md](file:///c:/Users/user/OneDrive/ドキュメント/Antigravity/world-building/world/magic/rules/hazards_survival_and_recovery.md) |
| **弾道・爆発・出血・臨死力学** | フルオート速射命中計算、遮蔽完全貫通、照準光学機器、爆発力学（REF換算/水中密閉爆発/破片）、出血判定、四肢切断・部位不随、臨死・死亡判定（-1HP〜-5HP）、野戦トリアージ | [firearms_explosives_and_injury.md](file:///c:/Users/user/OneDrive/ドキュメント/Antigravity/world-building/world/magic/rules/firearms_explosives_and_injury.md) |
| **戦術戦闘・格闘・防衛力学** | 1秒ターン手順、14大戦闘マニューバ、命中部位（急所/目/頭蓋）、トリック攻撃、組みつき・関節技・体当たり、3大能動防御（よけ/受け/止め）、さらなる努力 | [tactical_combat.md](file:///c:/Users/user/OneDrive/ドキュメント/Antigravity/world-building/world/magic/rules/tactical_combat.md) |
...
## 2. 呪文系統別アーカイブ一覧 (Spells by College)

本アーカイブは、2000年のマナ覚醒以降に体系化された理論魔導学派（メイジ）および伝統・儀式学派（シャーマニズム・神道等）で共通して行使される標準魔術（ガープスマジック体系）の公式リファレンスです。

| 系統番号 | 呪文系統名 | 英語名 | 収録状況 | ファイルリンク | 主な用途・現代適用 |
| :--- | :--- | :--- | :--- | :--- | :--- |
...
| **07** | **精神操作系** | Mind Control Spells | 58種 + 16種 | [mind.md](file:///c:/Users/user/OneDrive/ドキュメント/Antigravity/world-building/world/magic/spells/mind.md) | 催眠、恐怖耐性付与、アビス精神防壁、暴走魔獣鎮静 |
| **08** | **死霊系呪文** | Necromantic Spells | 44種 + 20種 | [necromantic.md](file:///c:/Users/user/OneDrive/ドキュメント/Antigravity/world-building/world/magic/spells/necromantic.md) | 専門魔法部隊の除霊・成仏、ゴースト交信、死体保存 |
| **09** | **技術系呪文** | Technological Spells | 45種 + 10種 | [technological.md](file:///c:/Users/user/OneDrive/ドキュメント/Antigravity/world-building/world/magic/spells/technological.md) | 機械制御、電脳魔術実験、燃料作成、放射線除染 |
| **10** | **毒系呪文** | Toxic & Poison Spells | 29種 + 13種 | [toxic_and_poison.md](file:///c:/Users/user/OneDrive/ドキュメント/Antigravity/world-building/world/magic/spells/toxic_and_poison.md) | 毒素探知・分析、毒液噴射、毒腺破裂、テイコク製薬生薬開発、検疫 |
| **11** | **門・扉・空間移動** | Gate & Space-Time | 主要8種＋派生 | [gate.md](file:///c:/Users/user/OneDrive/ドキュメント/Antigravity/world-building/world/magic/spells/gate.md) | 空間跳躍、次元門、4大アビス特異点封じ込め、特務展開 |
| **12** | **動物・魔獣制御** | Animal & Beast | 主要7系統分類 | [animal.md](file:///c:/Users/user/OneDrive/ドキュメント/Antigravity/world-building/world/magic/spells/animal.md) | 昆虫・魚・鳥・獣・合成獣制御、魔獣調教・養殖管理 |
