$lines = [System.IO.File]::ReadAllLines("scratch_301_400_table.txt", [System.Text.Encoding]::UTF8)
$clean = @()
...
[System.IO.File]::WriteAllLines("scratch_301_400_clean_summary.txt", $clean, [System.Text.Encoding]::UTF8)
