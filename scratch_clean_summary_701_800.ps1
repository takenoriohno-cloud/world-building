$lines = [System.IO.File]::ReadAllLines("scratch_701_800_table.txt", [System.Text.Encoding]::UTF8)
$clean = @()
...
[System.IO.File]::WriteAllLines("scratch_701_800_clean_summary.txt", $clean, [System.Text.Encoding]::UTF8)
