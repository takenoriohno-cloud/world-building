...
- **上位存在（動物王／精霊王／上位神性）の真名・固有名詞**:
  - **真名・固有名詞**: 『真名・固有名詞（原語表記）』
    - **動物のアーキタイプの王（Animal Lord / Beast Lord）**: 該当動物自身の鳴き声・発声器官の音素（ヒス音、遠吠え、唸り声、クリック音、呼気摩擦音等）で発音可能な固有名詞と音素構造の由来。
    - **精霊の王・領主（Elemental Lord / Spirit Lord）**: 精霊界の言語（Elemental Tongue）による音韻構造と原義の由来（エルリック型）。
  - **アストラル界での称号・階位**: （例: 《擬態と遅延の爬虫王》、第○階位大公等）
  - **アストラル原型・顕現形態**: （上位次元における真の姿、降臨時の規模や異能）
- **プレーン・パクト（次元契約）条件・誓約代償**:
  - **召喚・現出プロトコル**: （必要な触媒、儀式手順、精神同調条件）
  - **契約代償・誓約制約**: （術士が支払う代償、代謝変化、タブー）
- **アビス特異点との因果関係**: （4大アビス特異点からのマナ波長影響、歪曲変異の系譜）
- **メガコーポの極秘研究・特許利権**: （ヤマト重工、テイコク製薬、三ツ菱マナテック等の兵器・新薬・素材特許、防諜工作）
...
※本文各章の該当箇所に `[^zext_1]` や `[^takatsukasa_1]` などの脚注参照マークを配置し、本セクションに各専門ペルソナの小粋な冗談・現場小話を交えた査定メモを記述する。

[^zext_1]: ⚖️ **首席監査官ゼクスト（憲章監査室）**:
    「（憲章条文・特異災害指定・飼育規制等に対する客観的かつ時にドライなツッコミ）」

[^takatsukasa_1]: 🐾 **鷹司 冴子 博士（生態・生物調査部）**:
    「（解剖学・毒腺・ジビエ肉質・研究室での調理エピソードや学生とのやり取り）」

[^jinnai_1]: 🌍 **陣内 隆文 調査官（地理・環境調査部）**:
    「（現場ハンター・元自衛隊目線のリアルな交戦実感・防衛線や装備に対する現場の軽口）」

[^schulz_1]: 🏛️ **V・シュルツ 特命調査員（法務・古典文献考証部）**:
    「（古代ギリシャ/ローマ/中世文献の学術的皮肉や、現代メガコーポ法務部のあくどい特許独占に対する皮肉）」

[^kuroda_1]: ⚡ **クリスティナ・黒田 所長（魔導科学・理論研究部）**:
    「（GURPS Magic数理モデル・魔導熱力学・生体媒介原則や無茶なアイデアを出す学生・後輩への辛口コメント）」

[^hasumi_1]: 📸 **蓮見 蓮 プロデューサー（視覚・音響・資料記録部）**:
    「（ナショジオ流の過酷な野生撮影裏話・録音時のハプニング・胃薬や機材トラブルのエピソード）」
