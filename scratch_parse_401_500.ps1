...
[System.IO.File]::WriteAllLines("scratch_401_500_table.txt", $results, [System.Text.Encoding]::UTF8)
[System.IO.File]::WriteAllLines("scratch_401_500_full_text.txt", $full_text, [System.Text.Encoding]::UTF8)
Write-Output ("Extracted " + $results.Count + " pages for 401-500.")
